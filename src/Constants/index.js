...
export const calculateSizes =    (isSmall, isMobile, isTablet) => {
  return {
    ...
    reactLogoPosition: isSmall ? [4, 1, 0] : isMobile ? [7, 2, 0] : isTablet ? [5, 4, 0] : [12, 3, 0],
    ringPosition: isSmall ? [-8, 4, 0] : isMobile ? [-12, 5, 0] : isTablet ? [-12, 10, 0] : [-24, 10, 0],
    targetPosition: isSmall ? [-6, -9, -10] : isMobile ? [-9, -9, -10] : isTablet ? [-11, -7, -10] : [-13, -10, -10],
  };
};
